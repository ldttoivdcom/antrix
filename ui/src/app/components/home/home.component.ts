...
export class HomeComponent {
  Contents: HomeContent[] = [
    ...
    },
    {
      header: 'OUR PRODUCTS',
      description:
        'Antrix sells mission critical products for Medical Device, IVD, LDT, SaMD, Digital Health compliance. The products include',
      list: [
    ...
    },
    {
      header: 'OUR CLIENTS',
      description:
        'At Antrix, we have worked with a number of clients in the Medical Device, IVD, LDT, SaMD, Cybersecurity, Digital Health, Pharmaceutical, and Biotech Industries worldwide. ',
      list: [],
